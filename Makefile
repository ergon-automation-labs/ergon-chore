...
help:
	...
	@echo "  make logs            - Tail chore_bot log with grc (brew install grc; make -C .. install-grc)"
	@echo ""
...
_compile-impl:
	@LOG_FILE="/tmp/compile-chore-$$(date +%s).log"; \
	echo "Compiling chore and logging to $$LOG_FILE..."; \
...
release: check
	...
	@echo "==============================================="
	rm -rf _build/prod/rel/chore_bot
	MIX_ENV=prod $(MIX) release
	@echo ""
	@echo "✓ Release built successfully"
	@echo "Location: _build/prod/rel/chore_bot/"
	@echo ""
...
test-release-smoke:
	...
	@echo "==============================================="
	@RELEASE_NAME=chore_bot NATS_SERVERS=nats://localhost:4224 \
...
publish-release:
	...
	TARBALL=chore_bot-$$VERSION.tar.gz; \
	...
	if [ -f "$$TARBALL" ]; then \
		...
		tar -czf "$$TARBALL" -C _build/prod/rel chore_bot/; \
	...
	if gh release view "v$$VERSION" >/dev/null 2>&1; then \
		...
		gh release create "v$$VERSION" "$$TARBALL" \
			...
			--notes "Chore Bot Elixir release v$$VERSION" \
			--draft=false; \
	fi; \
