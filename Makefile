...
publish-release: release
	...
	tar -czf chore_bot-$$VERSION.tar.gz -C _build/prod/rel chore_bot/; \
	echo "✓ Tarball created: chore_bot-$$VERSION.tar.gz"; \
	echo ""; \
	\
	# Create GitHub release
	echo "Creating GitHub release v$$VERSION..."; \
	gh release create v$$VERSION chore_bot-$$VERSION.tar.gz \
		--title "Release v$$VERSION" \
		--notes "Chore Bot Elixir release v$$VERSION. Download and deploy with Jenkins." \
		--draft=false; \
